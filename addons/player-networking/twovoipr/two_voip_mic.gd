...
func processtalkstreamends(pttpressed):
...
func _process(delta):
	...
	if microphonefeed == null:
		...
		get_node("../MicNotPlayingWarning").visible = not microphonefeed.is_active()
