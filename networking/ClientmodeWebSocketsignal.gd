...
func stopwebsocketsignalclient():
	assert (websocketclient != null)
	set_process(false)
	websocketclient.disconnect("connection_closed", self, "wsc_connection_closed")
	websocketclient.disconnect("connection_error", self, "wsc_connection_error")
	websocketclient.disconnect("connection_established", self, "wsc_connection_established")
	websocketclient.disconnect("server_close_request", self, "wsc_server_close_request")
